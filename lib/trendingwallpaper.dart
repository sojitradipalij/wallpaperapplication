...
class TrendingWallpaper extends StatefulWidget {
  const TrendingWallpaper({Key? key}) : super(key: key);

  @override
  _TrendingWallpaperState createState() => _TrendingWallpaperState();
}

class _TrendingWallpaperState extends State<TrendingWallpaper> {
