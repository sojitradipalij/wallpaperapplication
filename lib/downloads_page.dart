...
import 'package:wallpaperapplication/downloaded_image_detail_page.dart';
...
class _DownloadedBloc {
  ...
  final ValueConnectableStream<List<_ListItem>> listItems$;
  ...
  factory _DownloadedBloc() {
    ...
    Future<Directory> getStorageDir() async {
      ...
      if (Platform.isAndroid) {
        _cachedStorageDir = Directory("storage/emulated/0/Download/WallpapersApp");
        if ((await _cachedStorageDir.exists())) {
          // TODO:
          print("exist");
        } else {
          // TODO:
          print("not exist");
          await _cachedStorageDir.create();
        }
        return _cachedStorageDir;
      }
      if (Platform.isIOS) {
    ...
    final images = ImageDB.getInstance().getDownloadedImages();
    print("images");
    print(images);
